...
declare_tests! {
    ...
    test_codegen_rescript => ReScript { async_style: AsyncStyle::All, root_module: "Stdb".to_string(), output_dir_strategy: spacetimedb_codegen::rescript::config::OutputDirStrategy::Flat, table_style: spacetimedb_codegen::rescript::config::TableStyle::Inline, out_dir: None },
}
