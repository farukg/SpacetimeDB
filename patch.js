...
// 1. Add generate_reducers_file to generate_global_files
code = code.replace(
...
// 2. Add generate_reducers_file function
const newFunc = `
    ...
    match ty {
        ...
        AlgebraicTypeUse::Ref(type_ref) => {
            ...
            if def.as_sum().is_some() {
                format!("encodeEnum(Obj.magic({val}))") // magic ensures ReScript variant compiles smoothly to JSON
            } else {
