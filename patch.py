...
with open("crates/codegen/src/rescript.rs", "r") as f:
    code = f.read()
...
code = code.replace("fn generate_types_file(module: &ModuleDef) -> OutputFile {", new_func + "\nfn generate_types_file(module: &ModuleDef) -> OutputFile {")

with open("crates/codegen/src/rescript.rs", "w") as f:
    f.write(code)
